...
public class CryptKeeperSettings extends Fragment {
    ...
    private Button.OnClickListener mInitiateListener = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            // SPRD: bug311474 get WifiManager to close wifi
            ...
            if (!runKeyguardConfirmation(KEYGUARD_REQUEST)) {
                ...
                new AlertDialog.Builder(getActivity())
                    ...
                    .create()
                    .show();
            // SPRD: add if wifi open when crypt,than close wifi
            } else if (mWifiManager.isWifiEnabled() 
                    || (Settings.Global.getInt(getActivity().getContentResolver(),Settings.Global.WIFI_SCAN_ALWAYS_AVAILABLE, 0) != 0)){
                mWifiManager.setWifiEnabled(false);
                Settings.Global.putInt(getActivity().getContentResolver(), Settings.Global.WIFI_SCAN_ALWAYS_AVAILABLE,0);
            }
        }
    };
