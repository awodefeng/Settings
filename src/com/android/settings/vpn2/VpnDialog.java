...
class VpnDialog extends AlertDialog implements TextWatcher,
  ...
  //SPRD: ADD for BUG386303
    public static final int MAX_CHARACTER_NUM = 512;
    ...
    public void afterTextChanged(Editable field) {
        ...
        */
        ...
        if (length > MAX_CHARACTER_NUM) {
        toast = Toast.makeText(getContext(), R.string.tilte_input_more, Toast.LENGTH_SHORT);
        toast.show();
        field.delete(MAX_CHARACTER_NUM, length);
        }
        /*
         * @}
         */
