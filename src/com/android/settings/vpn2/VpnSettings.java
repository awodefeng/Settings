        ...
        switch (item.getItemId()) {
            case R.id.vpn_create: {
                ...
                mDialog = new VpnDialog(
                        // SPRD：MODIFY for modify vpnDialog title
                        getActivity(), this, new VpnProfile(Long.toHexString(millis)), true,false);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.string.vpn_menu_edit:
                // SPRD：MODIFY for modify vpnDialog title
                mDialog = new VpnDialog(getActivity(), this, preference.getProfile(), true, true);
                mDialog.setOnDismissListener(this);
                mDialog.show();
                return true;
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (preference instanceof VpnPreference) {
            ...
            mDialog = new VpnDialog(getActivity(), this,
                    // SPRD：MODIFY for modify vpnDialog title
                    new VpnProfile(Long.toHexString(millis)), true, false);
        }
        mDialog.setOnDismissListener(this);
        mDialog.show();
        return true;
