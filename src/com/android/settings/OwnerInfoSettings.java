...
public class OwnerInfoSettings extends DialogFragment implements OnClickListener {
    ...
    private static boolean isShowToast = false;//SPRD:add for bug644701
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity())
                .setTitle(R.string.owner_info_settings_title_pikel)
                .setView(mView)
    ...
    private void initView() {
        ...
        isShowToast = false;//SPRD:add for bug644701
        ...
        mOwnerInfo.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() >= TEXT_MAX_LENGTH && !isShowToast) {//SPRD:add for bug644701
                    Toast.makeText(mContext, R.string.name_too_long,Toast.LENGTH_SHORT).show();
		    isShowToast = true;//SPRD:add for bug644701
                }
            }
        });
        /* @} */
