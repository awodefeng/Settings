...
public final class BluetoothDevicePreference extends Preference implements
    ...
    private ImageView mImageDeviceDetails;
    ...
    protected void onBindView(View view) {
        ...
        if (mCachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
             mImageDeviceDetails = (ImageView) view.findViewById(R.id.deviceDetails);

            if (mImageDeviceDetails != null) {
                // deviceDetails.setOnClickListener(this);
                mImageDeviceDetails.setClickable(false);
                mImageDeviceDetails.setTag(mCachedDevice);
            }
        }
    ...
    void onClicked() {
        ...
        Log.d(TAG, "onClicked bondState:"+bondState+", isConnected:"+mCachedDevice.isConnected());
    ...
    private void showDetailSetting(){
        Log.d(TAG, "showDetailSetting() mImageDeviceDetails="+mImageDeviceDetails);
        if (mImageDeviceDetails != null){
            onClick(mImageDeviceDetails);
        }
    }
