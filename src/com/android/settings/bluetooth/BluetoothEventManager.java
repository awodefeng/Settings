...
final class BluetoothEventManager {
    ...
    private class ScanningStateChangedHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent,
            ...
            if (mStarted) {
                if (isIloggable){
                    Log.startPerfTracking("Bluetooth : DISCOVERY start");
                }
            } else {
                if (isIloggable){
                    Log.stopPerfTracking("Bluetooth : DISCOVERY end ");
                }
            }
    ...
    private class DeviceFoundHandler implements Handler {
        public void onReceive(Context context, Intent intent,
            ...
            if (Log.isIloggable()){
                Log.startPerfTracking("Bluetooth : DeviceFound name = "+name+", address = "+device.getAddress());
            }
