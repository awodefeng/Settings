...
public class BluetoothPermissionActivity extends AlertActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        }else if (mRequestType == BluetoothDevice.REQUEST_TYPE_FTP_ACCESS) {
            showDialog(getString(R.string.bluetooth_ftp_acceptance_dialog_title), mRequestType);
        }
        else {
    ...
    private void showDialog(String title, int requestType)
    {
        ...
        case BluetoothDevice.REQUEST_TYPE_MESSAGE_ACCESS:
            ...
            break;
        case BluetoothDevice.REQUEST_TYPE_FTP_ACCESS:
    ...
    private View createFtpDialogView() {
        ...
        mView = getLayoutInflater().inflate(R.layout.bluetooth_access, null);
        messageView = (TextView)mView.findViewById(R.id.message);
        messageView.setText(getString(R.string.bluetooth_ftp_acceptance_dialog_text,
                mRemoteName, mRemoteName));
        return mView;
    }
