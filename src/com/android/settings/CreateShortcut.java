...
public class CreateShortcut extends LauncherActivity {
    ...
    private final static boolean HOTSPOT_DISABLED = SystemProperties.getInt("ro.hotspot.enabled", 0) == 0;
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        /* SPRD: Changed wifi_settings icon for bug406971 @{ */
        if (shortcutIntent.getComponent() != null
                && WifiSettingsActivity.class.getName().equals(
                        shortcutIntent.getComponent().getClassName())) {
            intent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE,
                    Intent.ShortcutIconResource.fromContext(this,
                            R.drawable.ic_settings_wireless_pikel));
        }
        /* @} */
    ...
    protected List<ResolveInfo> onQueryPackageManager(Intent queryIntent) {
        ...
        for (int i = activities.size() - 1; i >= 0; i--) {
            ...
            /* @} */
            if (HOTSPOT_DISABLED
                    && info.activityInfo.name.endsWith(HotspotSettingsActivity.class.getSimpleName())) {
                activities.remove(i);
            }
        }
        return activities;
