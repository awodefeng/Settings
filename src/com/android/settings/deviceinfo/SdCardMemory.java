 ...
 */
public class SdCardMemory extends SettingsPreferenceFragment {
    private static final String TAG = "SdCardMemory";
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.sdcard_info_memory);
    ...
    private void doUnmount() {
        if (ActivityManager.isUserAMonkey()) {
            Log.d(TAG, "ignoring monkey's attempt to unmount SD card");
            return;
        }
        ...
        try {
            if (sLastClickedMountToggle != null) {
    ...
    private static class ClearCacheObserver extends IPackageDataObserver.Stub {
        private final SdCardMemory mTarget;
        private int mRemaining;

        public ClearCacheObserver(SdCardMemory target, int remaining) {
            mTarget = target;
    ...
    public static class ConfirmClearCacheFragment extends DialogFragment {
        public static void show(SdCardMemory parent) {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    final SdCardMemory target = (SdCardMemory) getTargetFragment();
