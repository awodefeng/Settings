...
public class Status extends PreferenceActivity {
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // SPRD:ADD for Bug340221,Update bluetooth address info when bluetooth status changed
    ...
    protected void onResume() {
        ...
        // SPRD:ADD for Bug340221,Add a change event registered to the Receiver
    ...
    private void updateNetworkType() {
        ...
        if (TelephonyManager.NETWORK_TYPE_UNKNOWN != mTelephonyManager.getDataNetworkType()) {
            networktype = mTelephonyManager.getNetworkTypeName(mTelephonyManager.getDataNetworkType());
        }else if (TelephonyManager.NETWORK_TYPE_UNKNOWN != mTelephonyManager.getVoiceNetworkType()) {
            networktype = mTelephonyManager.getNetworkTypeName(mTelephonyManager.getVoiceNetworkType());
        }
    ...
    private void setIpAddressStatus() {
        ...
        String ipv6Address  = Utils.getIpv6Addresses(this);
        Log.e("Status","setIpAddressStatus ipv6Address: "+ipv6Address);
        if(ipAddress != null && !TextUtils.isEmpty(ipv6Address)){
            ipAddress += "\n";
