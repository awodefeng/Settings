...
public class LocationSettings extends LocationSettingsBase
    ...
    // private boolean focusWhenCreate = false;
...
//    }
    ...
    public void onResume() {
        ...
        // if (focusWhenCreate) {
        //     Log.d(TAG, "mSwitch requestFocus");
        //     mSwitch.requestFocus();
        //     focusWhenCreate = false;
        // }
        mValidListener = true;
    ...
    public void onPause() {
        ...
        mLocationSwitch.setOnPreferenceChangeListener(null);
    }
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        mLocationSwitch = (LocationSwitchPreference) root.findPreference(KEY_LOCATION_SWITCH);
        mLocationSwitch.setSwitchTextOff("");
        mLocationSwitch.setSwitchTextOn("");
        mLocationSwitch.setSummaryOn(R.string.accessibility_feature_state_on);
        mLocationSwitch.setSummaryOff(R.string.accessibility_feature_state_off);
        mLocationSwitch.setOnPreferenceChangeListener(this);
...
//        }
    ...
    public void onModeChanged(int mode, boolean restricted) {
        ...
        mLocationSwitch.setEnabled(!restricted);
...
//        }
        ...
        if (enabled != mLocationSwitch.isChecked()) {
            // set listener to null so that that code below doesn't trigger onPreferenceChange()
            if (mValidListener) {
                mLocationSwitch.setOnPreferenceChangeListener(null);
            }
    ...
    /**
     * Listens to the state change of the location master switch for new ui.
     */
    @Override
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        final String key = preference.getKey();
        if (KEY_LOCATION_SWITCH.equals(key)) {
