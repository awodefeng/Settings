...
public class TtsEnginePreference extends Preference {
    ...
    private boolean mIsChecked;//SPRD:add for bug628889
    ...
    public View getView(View convertView, ViewGroup parent) {
        ...
        if (!isChecked) {
            ...
            textLayout.setAlpha(Utils.DISABLED_ALPHA);//SPRD:add for bug628889
        }
        ...
        mSettingsIcon.setVisibility(View.GONE);//SPRD:add for bug628889
        return view;
    }
    ...
    //SPRD:add for bug628889 start
    public boolean isChecked() {
        return mIsChecked;
    }
    public void setChecked(boolean isChecked) {
        if (!mEngineInfo.name.equals(mSharedState.getCurrentKey())) {
