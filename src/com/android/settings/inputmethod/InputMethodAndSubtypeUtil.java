...
public class InputMethodAndSubtypeUtil {
    ...
    public static String buildInputMethodsAndSubtypesString(final HashMap<String, HashSet<String>> imsList) {
        boolean needsAppendSeparator = false;
    ...
    static HashMap<String, HashSet<String>> parseInputMethodsAndSubtypesString(
        ...
        final HashMap<String, HashSet<String>> subtypesMap = new HashMap<String, HashSet<String>>();
        ...
        while (sStringInputMethodSplitter.hasNext()) {
            ...
            if (sStringInputMethodSubtypeSplitter.hasNext()) {
                final HashSet<String> subtypeIdSet = new HashSet<String>();
    ...
    public static void enableInputMethodSubtypesOf(final ContentResolver resolver, final String imiId,
