...
public class WifiConnectionPolicyDialogActivity extends Activity implements
    ...
    private static final int MESSAGE_DIALOG_TIME_OUT_VALUE = 2 * 1000;
        ...
        switch (dialogType) {
            ...
            case WifiConnectionPolicy.DIALOG_TYPE_MOBILE_TO_WLAN_ALWAYS_ASK:
                ...
                if (!TextUtils.isEmpty(mSsidName)) {
                    mMessage.setText(mResources
                            .getText(R.string.mobile_to_wlan_popup_prefix)
                            + mSsidName + ","
                            + mResources.getText(R.string.mobile_to_wlan_popup_suffix));
                }
                break;
            case WifiConnectionPolicy.DIALOG_TYPE_WLAN_TO_MOBILE:
                // for cmcc case 4.10
