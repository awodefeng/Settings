...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // SPRD: To limit SSID's length
        mSsid.setFilters(new InputFilter[] {new Utf8ByteLengthFilter(32)});
        mPassword.setFilters(new InputFilter[] {new Utf8ByteLengthFilter(63)});
        ...
        showSecurityFields();
        validate();
        /* SPRD: fix bug277104 change soft input mode to show elements completely*/
    ...
    public void onClick(View view) {
        /* SPRD: modify curosr position for bug 268191 @{ */
