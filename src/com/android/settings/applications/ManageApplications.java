...
public class ManageApplications extends Fragment implements
    ...
    public static final String FILTER_APP_ITEM = "filter_app_item";
    ...
    public static class TabInfo implements OnItemClickListener {
        ...
        public View build(LayoutInflater inflater, ViewGroup contentParent, View contentChild) {
            ...
            if (mListContainer != null) {
                ...
                lv.setTextFilterEnabled(false);//SPRD:add for bug639334
                mListView = lv;
        ...
        public void rebuild(boolean eraseold) {
            ...
            switch (mFilterMode) {
                ...
                case FILTER_APPS_ALL:
                    filterObj = ApplicationsState.EVERYTHING_FILTER;
                    break;
                /* @} */
                default:
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String filterAppItem = (args != null) ? args.getString(FILTER_APP_ITEM) : ManageAppSettings.KEY_FILTER_APPS_ALL;
       ...
       if(filterAppItem.equals(ManageAppSettings.KEY_FILTER_APPS_THIRD_PARTY)){
        ...
        } else if(filterAppItem.equals(ManageAppSettings.KEY_FILTER_APPS_RUNNING)){
            tab = new TabInfo(this, mApplicationsState,
                    getActivity().getString(R.string.filter_apps_running),
                    LIST_TYPE_RUNNING, this, savedInstanceState);
        } else if(filterAppItem.equals(ManageAppSettings.KEY_FILTER_APPS_ONSDCARD)
                && ((Environment.STORAGE_TYPE_EMMC_INTERNAL != Environment.getStorageType())
        ...
        } else if(filterAppItem.equals(ManageAppSettings.KEY_FILTER_APPS_DISABLED)){
            tab = new TabInfo(this, mApplicationsState,
    ...
    void updateOptionsMenu() {
        ...
        if (mCurTab != null && mCurTab.mListType == LIST_TYPE_RUNNING) {
         ...
         //   mOptionsMenu.findItem(KILL_APPS_SERVICES).setVisible(!showingBackground);
            ...
            // SPRD： bug 643039 need sort by size or alpha
