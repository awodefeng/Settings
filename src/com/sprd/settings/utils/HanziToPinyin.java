/** Create by Spreadst */
package com.sprd.settings.utils;
...
public class HanziToPinyin {
    ...
    public static HanziToPinyin getInstance() {
        synchronized (HanziToPinyin.class) {
            ...
            for (int i = 0; i < locale.length; i++) {
                /* SPRD: add for 303219,hanzi to pinying will include more @{ */
    ...
    public static String getPingYinFormString(String soucre) {
        ...
        ArrayList<Token> pingYings = com.sprd.settings.utils.HanziToPinyin.getInstance().get(soucre);
